...
> **重要提醒：** 安装完成并不代表直接可用，需要先完成模型配置。请参考[配置信息](https://gitcode.com/openJiuwen/jiuwenclaw/blob/develop/docs/zh/%E9%85%8D%E7%BD%AE%E4%BF%A1%E6%81%AF.md)进行模型配置

---

## 安装前准备

在安装 JiuwenClaw 之前，请确保您的系统满足以下要求：
...
> 💡 **提示**：如果 Web 页面无法访问，请检查日志文件 `~/.jiuwenclaw/logs/` 是否有错误信息。

#### 4. 重新启动服务

如果关闭 JiuwenClaw 后需要再次使用：
...
- 需要手动构建并复制到 `~/.jiuwenclaw/web/dist`
...
- **代码仓库：** https://gitcode.com/openJiuwen/jiuwenclaw
- **问题反馈：** https://gitcode.com/openJiuwen/jiuwenclaw/issues
- **文档中心：** https://gitcode.com/openJiuwen/jiuwenclaw/tree/develop/docs
