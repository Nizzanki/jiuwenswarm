...
| **Skill Graph** | Visualize the capability relationships among installed skills |
| **Skill Index** | Build a local skill retrieval index and find matching skills by task need |
