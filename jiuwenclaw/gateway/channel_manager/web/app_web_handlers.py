...
from jiuwenclaw.agents.harness.common.auto_harness import AutoHarnessService
...
def _register_web_handlers(bind: WebHandlersBindParams) -> None:
    ...
    async def _forward_harness_to_agent(ws, req_id, params, session_id, *, req_method):
        ...
        if ac is None or not getattr(ac, "server_ready", False):
            ...
            from jiuwenclaw.agents.harness.common.auto_harness import (
    ...
    from jiuwenclaw.common.schema.message import ReqMethod as _HarnessReq
